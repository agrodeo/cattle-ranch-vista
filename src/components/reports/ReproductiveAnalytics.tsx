...
export const ReproductiveAnalytics = ({ filters: globalFilters }: ReproductiveAnalyticsProps) => {
  ...
  const calculateReproductiveStats = (animals: any[], iaServices: any[], tactos: any[], pregnancies: any[]): ReproductiveStats => {
    ...
    const allOffspring = animals.filter(a => a.mother_id);
    const liveOffspring = allOffspring.filter(a => a.status !== 'muerto');
    let totalSuccessfulCalvings = liveOffspring.length;
    ...
    console.log('DEBUG calving calculation:', {
