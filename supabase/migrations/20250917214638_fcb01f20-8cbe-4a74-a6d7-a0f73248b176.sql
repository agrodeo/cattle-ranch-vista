-- Drop the conflicting 4-parameter function that causes ambiguity
DROP FUNCTION IF EXISTS public.calculate_reproductive_kpis(uuid, date, date, uuid[]);

-- Ensure the 1-parameter function is working correctly
-- Update the function to return ALL reproductive females (15+ months), not just those with activities
