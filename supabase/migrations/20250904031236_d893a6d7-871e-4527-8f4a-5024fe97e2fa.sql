-- Fix the function to calculate category instead of selecting non-existent column
...
BEGIN
  ...
  SELECT 
    ...
    CASE 
      ...
      ELSE NULL 
    END as age_months,
    public.categorize_animal(a.birth_date, a.sex) as category,
    a.corral_id,
  ...
  WHERE a.cabaña_id = cabana_uuid
    AND a.sex = 'Hembra'
    AND public.categorize_animal(a.birth_date, a.sex) IN ('Vaquillona', 'Vaca')
