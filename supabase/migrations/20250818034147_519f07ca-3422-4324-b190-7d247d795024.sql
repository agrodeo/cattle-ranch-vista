-- Eliminar todas las referencias a las jurisdicciones obsoletas antes de eliminarlas
...
-- Crear las reglas de vacunación específicas para Argentina
...
-- Ahora eliminar las jurisdicciones obsoletas
