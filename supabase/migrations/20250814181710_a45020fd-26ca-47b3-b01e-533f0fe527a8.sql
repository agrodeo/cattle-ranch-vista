...
-- Create function to calculate age at death
...
-- Create trigger to calculate age at death
CREATE TRIGGER calculate_death_age_trigger
  BEFORE INSERT OR UPDATE ON public.defunciones
  FOR EACH ROW
  EXECUTE FUNCTION public.calculate_death_age();
