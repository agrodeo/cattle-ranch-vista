-- Fix the data type mismatch by updating return types to match actual returned data
...
RETURNS TABLE(
  ...
  days_open integer, 
  reproductive_years numeric, -- Changed from integer to numeric to match CEIL return type
