-- Fix the rpc_report_corrals_last_season function to return correct columns
...
-- Fix the rpc_report_reproduction_animals function to avoid ambiguous column references
