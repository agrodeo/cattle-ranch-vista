-- First insert vaccine codes that don't exist yet
INSERT INTO public.vaccines (code, name, description) VALUES 
('FA', 'Fiebre Aftosa', 'Vacuna contra fiebre aftosa'),
('CARBUNCLO', 'Carbunclo', 'Vacuna contra carbunclo (ántrax bovino)'),
('BRUCELOSIS', 'Brucelosis', 'Vacuna contra brucelosis')
...
('AR', 'BRUCELOSIS', true, true, 'F', 'cualquiera', 90, 365, 'Programa nacional de brucelosis - terneras', 'https://argentina.gob.ar');
