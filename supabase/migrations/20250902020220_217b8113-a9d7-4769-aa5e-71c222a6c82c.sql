-- Insert vaccine rules for all countries (without conflict resolution)
...
INSERT INTO vaccine_rules (
  ...
  ('fmd', 'CL', false, false, null, 30, 'ANY', null, null, 'cualquiera', false, 'PROHIBIDA - Chile es libre sin vacunación', 1, false),
  ('fmd', 'BR', false, false, null, 30, 'ANY', null, null, 'cualquiera', false, 'NO se vacuna - Brasil libre sin vacunación', 1, false),
  ('fmd', 'MX', false, false, null, 30, 'ANY', null, null, 'cualquiera', false, 'NO se vacuna - México libre desde 1955', 1, false);