...
-- Create RLS policies
CREATE POLICY IF NOT EXISTS "prices_ro" ON public.billing_prices FOR SELECT USING (true);
...
CREATE POLICY IF NOT EXISTS "admin_customers_management" ON public.billing_customers
  FOR ALL USING (true);

CREATE POLICY IF NOT EXISTS "admin_subscriptions_management" ON public.billing_subscriptions
  FOR ALL USING (true);

CREATE POLICY IF NOT EXISTS "admin_payments_management" ON public.billing_payments
  FOR ALL USING (true);

CREATE POLICY IF NOT EXISTS "admin_prices_management" ON public.billing_prices
  FOR ALL USING (true);