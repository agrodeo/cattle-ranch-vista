-- Fix BIGINT to INTEGER type mismatch in rpc_reproductive_detailed_metrics function
-- Cast all COUNT() operations to INTEGER to match function signature
...
BEGIN
  ...
  reproductive_calculations AS (
    SELECT 
      ...
      -- Cast reproductive years calculation to INTEGER
      GREATEST(1, 
        CASE 
