...
-- Create new function with username parameter
...
-- Drop existing verify function and recreate
DROP FUNCTION IF EXISTS public.verify_user_login(text,text);

-- Update the verification function to use username instead of email/employee_code
