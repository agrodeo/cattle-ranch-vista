-- Update the create_company_with_owner function to include herd_settings configuration
...
BEGIN
  ...
  -- Create herd settings with the selected country and region
  INSERT INTO public.herd_settings (
    ...
    new_cabana_id,
    COALESCE(country, 'Argentina'),
    region,
    'mixed', -- Default herd type
    'natural_and_ai', -- Default service type 
    'strict' -- Default compliance mode
  );
