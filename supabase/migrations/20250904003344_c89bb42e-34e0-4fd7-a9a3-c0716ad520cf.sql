-- Drop and recreate the functions with fixed SQL errors

-- Drop existing functions first
DROP FUNCTION IF EXISTS public.rpc_report_corrals_last_season(uuid);
DROP FUNCTION IF EXISTS public.rpc_report_reproduction_animals(uuid, jsonb);

-- Recreate the corrals function with correct return type
...
-- Recreate the reproduction function with fixed column references
