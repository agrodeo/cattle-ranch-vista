...
-- Create improved version with historical weight-based ADG calculation
...
BEGIN
  ...
  adg_season_calc AS (
    SELECT 
      ea.id as animal_id,
      CASE
        -- Priority 1: Complete historical weights (birth + final)
        ...
        THEN
          ROUND(
            ...
            NULLIF((CURRENT_DATE - ea.birth_date)::numeric, 0),
            3
          )
        
        -- Priority 2: Birth + Weaning weights
        WHEN ea.peso_nacimiento IS NOT NULL 
