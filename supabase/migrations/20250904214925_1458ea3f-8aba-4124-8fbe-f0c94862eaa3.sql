-- Fix pregnancy percentage calculation to properly include current pregnancy status
...
BEGIN
  ...
  reproductive_stats AS (
    SELECT 
      ...
      -- Calculate realistic pregnancy rate: MIN(100, total pregnancies per reproductive year * 100)
      LEAST(100.0, 
        CASE 
