    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Hr style={hr} />
          <Heading style={heading}>Cambio de email</Heading>
          <Text style={text}>
            Solicitaste cambiar tu email{newEmail ? ` a ${newEmail}` : ''}. Hacé clic en el botón para confirmar el cambio.
          </Text>
          ...
          <Text style={textMuted}>
            Si no solicitaste este cambio, contactá a soporte inmediatamente.
          </Text>
          <Hr style={hr} />
          <Text style={footer}>
